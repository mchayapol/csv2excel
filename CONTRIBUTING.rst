...
Welcome to ``csv2excel`` contributor's guide.
...
If you experience bugs or general issues with ``csv2excel``, please have a look
...
You can help improve ``csv2excel`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``csv2excel`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``csv2excel``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n csv2excel python=3 six virtualenv pytest pytest-cov
    conda activate csv2excel
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/csv2excel.git
    cd csv2excel
...
#. Install |pre-commit|_::
   ...
   ``csv2excel`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/csv2excel
.. _issue tracker: https://github.com/<USERNAME>/csv2excel/issues
.. <-- end -->
